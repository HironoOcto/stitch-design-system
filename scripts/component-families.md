...
<!-- demo 侧栏分组也读此表（族表 ∩ demo/components/*），与 build:refs 同源，别另搞一套 -->
...
| chat | conversation & messaging | ChatMessage, ChatMessageActions, ChatList, ChatInput, TypingIndicator, ChatImage, ChatFile, ChatVoice |
