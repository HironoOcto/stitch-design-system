// demo/layouts/landing/index.tsx —— 版式样例 · 落地页（第一个 LAYOUT 条目）
//
// 把**真组件**（@octohirono/stitch-design-system import）组合成一个整页，跨主题切站
// 看**综合换肤**。仅连接件（hero 外壳 / section 通栏带 / 网格）手写，且**只读
// var(--stitch-*)**（H2；hex/圆角/字体一律不硬编码）。full-bleed：通栏底色带贴内容区边缘，
// 正文列自收 --stitch-page-max-width 居中。压满页面尺度层四键 + display-caption 整条字阶。
...
export const meta = {
  title: 'Landing',
  description:
    '落地页版式样例：真组件组合成整页，跨 seline/steep/phantom 看综合换肤。',
};
